...
{
    /**
     * Follow-request aware contact views: counts only see accepted follows,
     * and relationships expose the follow status. Recreated in dependency
     * order because contact_relationships selects from contact_profiles.
     */
