...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 50, // 50MB — sized for rehearsal voice recordings (~21MB/hour of Opus)
     ...
     */
    // Media Library Pro (optional package); referenced as a string so analysis
    // doesn't require the Pro class to be installed.
